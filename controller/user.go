...
func buildSelfUserData(user *model.User) map[string]any {
	...
	affiliateRewardsConfig := map[string]any{
		"quota_for_inviter":               common.QuotaForInviter,
		"quota_for_invitee":               common.QuotaForInvitee,
		"invitation_activation_threshold": common.InvitationActivationThreshold,
		"commission_rate":                 common.CommissionRate,
	}
	...
	return map[string]any{
		...
		"aff_reward_quota":         user.AffRewardQuota,
		"aff_commission_quota":     user.AffCommissionQuota,
		"aff_valid_count":          user.AffValidCount,
