...
func InitOptionMap() {
	...
	common.OptionMap["InvitationActivationThreshold"] = strconv.Itoa(common.InvitationActivationThreshold)
	common.OptionMap["CommissionRate"] = strconv.Itoa(common.CommissionRate)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InvitationActivationThreshold":
		common.InvitationActivationThreshold, _ = strconv.Atoi(value)
	case "CommissionRate":
		common.CommissionRate, _ = strconv.Atoi(value)
