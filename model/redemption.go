...
func Redeem(key string, userId int) (quota int, err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		_, err = creditTopUpQuota(tx, userId, redemption.Quota, nil, false, WalletLedgerMeta{Type: WalletLedgerTypeRedemption, SourceType: "redemption", SourceId: strconv.Itoa(redemption.Id)})
		return err
	})
	if err != nil {
